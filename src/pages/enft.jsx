...
export default function ENFT(props) {
	...
	return (
		<div className="page my-tokens">
			{
				props.network == 4 ?
				(<h2>NFTs</h2>):(<h2>You are not on rinkeby, you should change the network on your wallet to see your NFTs on Mumbai</h2>)
			}

			{props.network== 4 ? (tokenURIs.map((uri, idx) => (
				<div key={idx}>
